...
<!-- Dica: Curva de Contratos Simbólica {{{ -->
...
<!-- Dica: encontrar demandas brutas, líquidas e agregadas{{{ -->
...
<!-- Dica: encontrar preços de equilíbrio {{{ -->
...
#| label: demanda-continua 
#| echo: true
#| code-fold: true
#| fig-cap: "Necessidade da curva de demanda ser contínua"
#| fig-align: center
#| fig-ext: svg
#| out-width: 100%
...
## Os Teoremas do Bem-Estar Social `TODO`
